...
@app.route("/api/users")
def users():
    # User(user_id=3, first_name="Chrissie", last_name="James", email="christ_james@yahoo.com",password="123").save()
    # User(user_id=4, first_name="Johnathon", last_name="James", email="John_james@yahoo.com",password="123").save()
